  ...
  return (
    <>
      ...
      <section className="affiliate-banner">
        <div className="affiliate-content">
          ...
          <div style={{ display: 'flex', gap: '30px', justifyContent: 'center', flexWrap: 'wrap', margin: '20px 0' }}>
            ...
            <div className="commission-badge" style={{ background: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 100%)' }}>
      ...
      <section className="journal-banner">
        ...
        <a href="/journal" className="btn-journal">Open Free Journal →</a>
      </section>
        ...
        <div className="section-container">
          ...
          <div className="faq-grid">
            <div className="faq-item active">
              <div className="faq-question" onClick={(e) => toggleFaq(e.currentTarget)}>Is this suitable for complete beginners?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => toggleFaq(e.currentTarget)}>Do I need real money to trade?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => toggleFaq(e.currentTarget)}>How long do I have access?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => toggleFaq(e.currentTarget)}>What if I miss a day?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => toggleFaq(e.currentTarget)}>Can I get a refund?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => toggleFaq(e.currentTarget)}>How does the affiliate program work?</div>
      ...
      <footer className="footer">
        <div className="section-container">
          ...
          <div className="footer-links">
            ...
            <a href="/journal" className="footer-link">Free Journal</a>
          </div>

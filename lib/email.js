      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 32px; background: #f8fafc;">
          ...
          <div style="background: white; padding: 24px; border-radius: 8px; margin: 24px 0; text-align: center;">
            ...
            <p style="color: #1e3a5f; font-weight: bold; margin: 0;">
              You're ${Math.round((dayNumber/30)*100)}% through the challenge!
            </p>
          </div>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 32px; background: #f8fafc;">
          ...
          <p style="color: #64748b; line-height: 1.7;">
            ...
            This is a huge achievement that puts you ahead of 95% of traders.
          </p>
          <div style="background: white; padding: 24px; border-radius: 8px; margin: 24px 0; text-align: center;">
            <div style="font-size: 64px; margin-bottom: 12px;">🎓</div>
            <p style="color: #1e3a5f; font-weight: bold; font-size: 20px; margin: 0;">
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 32px; background: #f8fafc;">
          <p style="font-size: 18px; color: #1e3a5f;">Hey ${name || 'Trader'}!</p>
          <p style="color: #64748b; line-height: 1.7;">
            We noticed you haven't logged in for a while. Your trading journey is waiting!
          </p>
          <div style="background: white; padding: 24px; border-radius: 8px; margin: 24px 0;">
            <p style="color: #1e3a5f; margin: 0;">
              <strong>You're on Day ${lastDay}</strong> - don't let your progress go to waste!
            </p>
          </div>
          <a href="${appUrl}/dashboard" 
             style="display: inline-block; padding: 14px 28px; background: #667eea; color: white; text-decoration: none; border-radius: 8px; font-weight: bold;">

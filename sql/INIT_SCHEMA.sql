...
-- Table: app_settings
--
-- Stores key/value pairs for global application settings.  This
-- includes configuration values such as the active Stripe price ID.
...
create policy "Service role accesses app settings" on public.app_settings
  for all using ( auth.role() = 'service_role' );
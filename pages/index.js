 ...
 *
 * IDENTICAL to templates/index.html - same CSS, layout, content
 */
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Transform from complete beginner to confident trader in 30 days. Learn market analysis, trading strategies, and risk management with our structured challenge." />
      ...
      <section className="affiliate-banner">
        <div className="affiliate-content">
          ...
          <div className="commission-badges">
            ...
            <div className="commission-badge commission-badge-gold">
              <div className="commission-rate commission-rate-gold">30%</div>
      ...
      <section className="journal-banner">
        ...
        <Link href="/free-journal" className="btn-journal">Open Free Journal →</Link>
      </section>
      ...
      <section id="faq" className="faq">
        <div className="section-container">
          ...
          <div className="faq-grid">
            {[
              { q: 'Is this suitable for complete beginners?', a: 'Absolutely! The challenge is designed specifically for people with zero trading experience. We start from the very basics and build up gradually over 30 days.' },
              { q: 'Do I need real money to trade?', a: 'No! We strongly recommend using only demo/virtual accounts during the entire challenge. You\'ll learn with fake money until you\'re consistently profitable. Never risk real money while learning.' },
              { q: 'How long do I have access?', a: 'You have 120 days (4 months) of platform access from your purchase date. Your certificate is yours forever once earned.' },
              { q: 'What if I miss a day?', a: 'No problem! Days unlock automatically every 24 hours, but you can complete them at your own pace within your 120-day access period. You must pass each quiz (60%+) to proceed.' },
              { q: 'Can I get a refund?', a: 'Yes! We offer a 3-day money-back guarantee. If you\'re not satisfied within 72 hours of purchase, contact support for a full refund, no questions asked.' },
              { q: 'How does the affiliate program work?', a: 'Anyone can join our affiliate program - no purchase required! Sign up free and get your unique link. Standard affiliates earn 25% ($10) per sale. Complete the course and upgrade to Graduate status for 30% ($12) per sale. Payouts are automatic via Stripe.' },
            ].map((faq, index) => (
      ...
      <footer className="footer">
        <div className="section-container">
          ...
          <div className="footer-links">
            ...
            <Link href="/free-journal" className="footer-link">Free Journal</Link>
          </div>

    ...
    <>
      ...
      <section id="pricing" className="pricing">
        <div className="section-container">
          ...
          <div className="pricing-card">
            ...
            <div className="price" id="displayPrice">$39.99</div>
      ...
      <section className="affiliate-banner">
        <div className="affiliate-content">
          ...
          <p><a href="/login?affiliate=true" style={{ color: '#059669', fontWeight: 600 }}>Sign up as affiliate</a> to get your referral link. Automatic payouts via Stripe.</p>
        </div>
      </section>
      ...
      <section className="journal-banner">
        ...
        <a href="/free-journal" className="btn-journal">Open Free Journal →</a>
      </section>
        ...
        <div className="section-container">
          ...
          <div className="faq-grid">
            <div className="faq-item active">
              <div className="faq-question" onClick={(e) => window.toggleFaq(e.target)}>Is this suitable for complete beginners?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => window.toggleFaq(e.target)}>Do I need real money to trade?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => window.toggleFaq(e.target)}>How long do I have access?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => window.toggleFaq(e.target)}>What if I miss a day?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => window.toggleFaq(e.target)}>Can I get a refund?</div>
            ...
            <div className="faq-item">
              <div className="faq-question" onClick={(e) => window.toggleFaq(e.target)}>How does the affiliate program work?</div>
      ...
      <footer className="footer">
        <div className="section-container">
          <p>&copy; 2025 Market Warrior. All rights reserved.</p>
          <div className="footer-links">
            <a href="/terms" className="footer-link">Terms & Conditions</a>
            <a href="/privacy" className="footer-link">Privacy Policy</a>
            <a href="/free-journal" className="footer-link">Free Journal</a>
          </div>

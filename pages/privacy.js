 ...
 * Privacy Policy Page
 *
 * GDPR-compliant privacy policy for Market Warrior.
 */
export default function PrivacyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Market Warrior</title>
      </Head>
      ...
      <div className="container">
        ...
        <p>Contact our Data Protection team at <strong>support@marketwarrior.club</strong>. We will respond to your request within 30 days. You may also lodge a complaint with your local data protection authority.</p>

        <h2>7. Legal Basis for Processing (GDPR)</h2>
        <p>We process your personal data based on the following legal grounds:</p>
        <ul>
          <li><strong>Contract Performance:</strong> To provide the course you purchased and manage your account</li>
          <li><strong>Legitimate Interests:</strong> To improve our services, prevent fraud, and ensure platform security</li>
          <li><strong>Legal Obligations:</strong> To comply with tax laws and financial regulations</li>
        ...
        <ul>
          ...
          <li>Trading journal entries: Duration of account (can be exported upon request)</li>
        </ul>
        ...
        <ul>
          <li>Standard Contractual Clauses (SCCs) for data transfers outside the EU</li>
        ...
        <h2>12. Contact Us</h2>
        <p>For questions about this Privacy Policy or your data, please contact:</p>
        <p><strong>General Support:</strong> support@marketwarrior.club</p>
